  ...
  <div id="socketsFloor" class="socket-floor">
    ...
    <el-row class="socket-bottom" v-loading='load' element-loading-text="开关操作中">
      ...
      <el-dialog title="群控选择" :visible.sync="dialogFanVisible" class="controlDialog"  id="qkSetTable">
        <!-- <div class="groupcontrol-button">
          <el-button size="small" @click="turns()" :disabled="turnBtn" type="success">设定</el-button>
        </div> -->
        <div class="groupcontrol">         
          <div class="groupcontrol-top" style="z-index: 1">
            ...
            <div class="groupcontrol-top-left">
              <!-- <div style="flex:1">
                <el-radio-group v-model="radio2">
                  <el-radio :label="2">设备</el-radio>
                  <el-radio :label="1">广播</el-radio>
                </el-radio-group>
              </div> -->
              <div class="groupcontrol-footer-cont" style="flex:1;display:flex;align-items:center;justify-content:center">
                <span>设定状态：</span>
            ...
            <div class="groupcontrol-top-right">
              <el-checkbox-group v-model="gatewayCheckList">
                <el-checkbox :label="item.commId" v-for="(item,index) in gatewayList" :key="index">{{item.commEquipName}}</el-checkbox>
              </el-checkbox-group>
            </div> 
            <div class="groupcontrol-top-btn">
              <el-button size="mini" @click="turns()" :disabled="turnBtn" type="success">设定</el-button>
            </div>       
          </div>
          ...
          <div style="flex:1" >
            ...
            <el-form :model="socketSetDataFormAll" :rules="socketSetDataRuleAll" ref="socketSetDataFormAll" class="set-device-form setchecks"  v-loading = 'fiexdQueryAllLoading' element-loading-text="定值设置中">
              <div class="set-device-form-left">
                <el-form-item label="插座地址" class="set-device-form-item">
                  <el-input v-model="socketSetDataFormAll.n1" placeholder="" size="small" disabled></el-input>
                  <el-radio :label="'n1' + '-' +socketSetDataFormAll.n1"></el-radio>
                </el-form-item>
                <el-form-item label="以太网地址" class="set-device-form-item">
                ...
                <el-form-item label="接入负荷类型" class="set-device-form-item">
                ...
                <el-form-item label="数据上传速度" class="set-device-form-item">
                ...
                <el-form-item label="频率刚性切除功能" class="set-device-form-item">
                ...
                <el-form-item label="快速刚性切除频率" class="set-device-form-item">
                  <!-- <el-input v-model="socketSetDataFormAll.n7" placeholder="" size="small"></el-input> -->
                  <el-input-number v-model="socketSetDataFormAll.n7" placeholder="45~55" size="small" :max="55.00" :min="45.00" :step="0.01"></el-input-number>
                  <el-radio :label="'n7' + '-' +socketSetDataFormAll.n7"></el-radio>
                </el-form-item>
                <el-form-item label="快速刚性切除延时" class="set-device-form-item">
                  <!-- <el-input v-model="socketSetDataFormAll.n8" placeholder="" size="small"></el-input> -->
                  <el-input-number v-model="socketSetDataFormAll.n8" placeholder="1~3000" size="small" :max="3000" :min="1" :step="10"></el-input-number>
                  <el-radio :label="'n8' + '-' +socketSetDataFormAll.n8"></el-radio>
                </el-form-item>
                <el-form-item label="频率滑差闭锁定值" class="set-device-form-item">
                  <!-- <el-input v-model="socketSetDataFormAll.n9" placeholder="" size="small"></el-input> -->
                  <el-input-number v-model="socketSetDataFormAll.n9" placeholder="1~255" size="small" :max="255" :min="1" :step="1"></el-input-number>
                  <el-radio :label="'n9' + '-' +socketSetDataFormAll.n9"></el-radio>
                </el-form-item>
                <el-form-item label="频率自动恢复负荷" class="set-device-form-item">
              ...
              <div class="set-device-form-right"> 
                <el-form-item label="频率自动恢复负荷频率" class="set-device-form-item-right">
                  <!-- <el-input v-model="socketSetDataFormAll.n11" placeholder="" size="small"></el-input> -->
                  <el-input-number v-model="socketSetDataFormAll.n11" placeholder="45~55" size="small" :max="55.00" :min="45.00" :step="0.01"></el-input-number>
                  <!-- <el-select 
                ...
                <el-form-item label="按频率自动恢复负荷延时" class="set-device-form-item-right">
                  <!-- <el-input v-model="socketSetDataFormAll.n12" placeholder="" size="small"></el-input> -->
                  <el-input-number v-model="socketSetDataFormAll.n12" placeholder="1~3000" size="small" :max="3000" :min="1" :step="10"></el-input-number>
                ...
                <el-form-item label="夏季制冷期间柔性调控(℃)" class="set-device-form-item-right">
                  ...
                  <el-input-number v-model="socketSetDataFormAll.n13" placeholder="18~28" size="small" :max="28" :min="18" :step="1"></el-input-number>
                ...
                <el-form-item label="冬季制热期间柔性调控(℃)" class="set-device-form-item-right">
                  ...
                  <el-input-number v-model="socketSetDataFormAll.n14" placeholder="18~28" size="small" :max="28" :min="18" :step="1"></el-input-number>
                  <el-radio :label="'n14' + '-' +socketSetDataFormAll.n14"></el-radio>
                </el-form-item>
                <el-form-item label="空调软启停的控制" class="set-device-form-item-right">
                  <!-- <el-input v-model="socketSetDataFormAll.n15" placeholder="" size="small"></el-input> -->
                  <el-select 
                    v-model="socketSetDataFormAll.n15" clearable>
                    <el-option
                      v-for="item in sfValue"
                      :key="item.value"
                      :label="item.label"
                      :value="item.value">
                    </el-option>
                ...
                <el-form-item label="负荷停运判断定值" class="set-device-form-item-right">
                  <!-- <el-input v-model="socketSetDataFormAll.n16" placeholder="" size="small"></el-input> -->
                  <el-input-number v-model="socketSetDataFormAll.n16" placeholder="1~1000" size="small" :max="1000" :min="1" :step="10"></el-input-number>
                  <el-radio :label="'n16' + '-' +socketSetDataFormAll.n16"></el-radio>
                </el-form-item>          
                <el-form-item label="过流保护功能" class="set-device-form-item-right">
                  <!-- <el-input v-model="socketSetDataFormAll.n17" placeholder="" size="small"></el-input> -->
                  <el-select 
                    v-model="socketSetDataFormAll.n17" clearable>
                    <el-option
                      v-for="item in sfValue"
                      :key="item.value"
                      :label="item.label"
                ...
                <el-form-item label="插座的过流保护定值" class="set-device-form-item-right">
                  <!-- <el-input v-model="socketSetDataFormAll.n18" placeholder="" size="small"></el-input> -->
                  <el-input-number v-model="socketSetDataFormAll.n18" placeholder="16~25" size="small" :max="25" :min="16" :step="1"></el-input-number>
                  <el-radio :label="'n18' + '-' +socketSetDataFormAll.n18"></el-radio>
                </el-form-item>
                <el-form-item label="插座的过流保护延时" class="set-device-form-item-right">
                  <!-- <el-input v-model="socketSetDataFormAll.n19" placeholder="" size="small"></el-input> -->
                  <el-input-number v-model="socketSetDataFormAll.n19" placeholder="1~3000" size="small" :max="3000" :min="1" :step="10"></el-input-number>
                ...
                <el-form-item label="过热保护功能是否启用" class="set-device-form-item-right">
                  ...
                  <el-select 
                    v-model="socketSetDataFormAll.n20" clearable>
                    <el-option
                      v-for="item in sfValue"
                      :key="item.value"
                      :label="item.label"
      ...
      <el-dialog        
       ...
       :close-on-click-modal="false"
        ...
        <el-radio-group v-model="checkList" style="width:100%">
        <el-form :model="socketSetDataForm" :rules="socketSetDataRule" ref="socketSetDataForm" class="set-device-form setcheck" v-loading = 'fiexdQueryLoading' element-loading-text="处理中">          
          <div class="set-device-form-left">         
            <el-form-item label="插座地址" class="set-device-form-item">
              <el-input v-model="socketSetDataForm.n1" placeholder="" size="small" disabled></el-input>
            ...
            <el-form-item label="快速刚性切除频率" class="set-device-form-item">
              <!-- <el-input v-model="socketSetDataForm.n7" placeholder="" size="small" type="number" :max="55" :min="45"></el-input> -->
              <el-input-number v-model="socketSetDataForm.n7" placeholder="45~55" size="small" :max="55.00" :min="45.00" :step="0.01"></el-input-number>
              <el-radio :label="'n7' + '-' +socketSetDataForm.n7"></el-radio>
            </el-form-item>
            <el-form-item label="快速刚性切除延时" class="set-device-form-item">
              <!-- <el-input v-model="socketSetDataForm.n8" placeholder="" size="small"></el-input> -->
              <el-input-number v-model="socketSetDataForm.n8" placeholder="1~3000" size="small" :max="3000" :min="1" :step="10"></el-input-number>
              <el-radio :label="'n8' + '-' +socketSetDataForm.n8"></el-radio>
            </el-form-item>
            <el-form-item label="频率滑差闭锁定值" class="set-device-form-item">
              <!-- <el-input v-model="socketSetDataForm.n9" placeholder="" size="small"></el-input> -->
              <el-input-number v-model="socketSetDataForm.n9" placeholder="1~255" size="small" :max="255" :min="1" :step="1"></el-input-number>
          ...
          <div class="set-device-form-right">
            <el-form-item label="频率自动恢复负荷频率" class="set-device-form-item-right">
              ...
              <el-input-number v-model="socketSetDataForm.n11" placeholder="45~55" size="small" :max="55.00" :min="45.00" :step="0.01"></el-input-number>
              <!-- <el-select 
            ...
            <el-form-item label="按频率自动恢复负荷延时" class="set-device-form-item-right">
              ...
              <el-input-number v-model="socketSetDataForm.n12" placeholder="1~3000" size="small" :max="3000" :min="1" :step="10"></el-input-number>
              <el-radio :label="'n12' + '-' +socketSetDataForm.n12"></el-radio>
            </el-form-item>
            <el-form-item label="夏季制冷期间柔性调控(℃)" class="set-device-form-item-right">
              <!-- <el-input v-model="socketSetDataForm.n13" placeholder="" size="small"></el-input> -->
              <el-input-number v-model="socketSetDataForm.n13" placeholder="18~28" size="small" :max="28" :min="18" :step="1"></el-input-number>
              <el-radio :label="'n13' + '-' +socketSetDataForm.n13"></el-radio>
            </el-form-item>
            <el-form-item label="冬季制热期间柔性调控(℃)" class="set-device-form-item-right">
              <!-- <el-input v-model="socketSetDataForm.n14" placeholder="" size="small"></el-input> -->
              <el-input-number v-model="socketSetDataForm.n14" placeholder="18~28" size="small" :max="28" :min="18" :step="1"></el-input-number>
              <el-radio :label="'n14' + '-' +socketSetDataForm.n14"></el-radio>
            </el-form-item>
            <el-form-item label="空调软启停的控制" class="set-device-form-item-right">
              <!-- <el-input v-model="socketSetDataForm.n15" placeholder="" size="small"></el-input> -->
              <el-select 
                v-model="socketSetDataForm.n15" clearable>
                <el-option
                  v-for="item in sfValue"
                  :key="item.value"
                  :label="item.label"
            ...
            <el-form-item label="负荷停运判断定值" class="set-device-form-item-right">
              ...
              <el-input-number v-model="socketSetDataForm.n16" placeholder="1~1000" size="small" :max="1000" :min="1" :step="10"></el-input-number>
              <el-radio :label="'n16' + '-' +socketSetDataForm.n16"></el-radio>
            </el-form-item>        
            <el-form-item label="过流保护功能" class="set-device-form-item-right">
              <!-- <el-input v-model="socketSetDataForm.n17" placeholder="" size="small"></el-input> -->
              <el-select 
                v-model="socketSetDataForm.n17" clearable>
                <el-option
                  v-for="item in sfValue"
                  :key="item.value"
                  :label="item.label"
            ...
            <el-form-item label="插座的过流保护定值" class="set-device-form-item-right">
              ...
              <el-input-number v-model="socketSetDataForm.n18" placeholder="16~25" size="small" :max="25" :min="16" :step="1"></el-input-number>
              <el-radio :label="'n18' + '-' +socketSetDataForm.n18"></el-radio>
            </el-form-item>
            <el-form-item label="插座的过流保护延时" class="set-device-form-item-right">
              <!-- <el-input v-model="socketSetDataForm.n19" placeholder="" size="small"></el-input> -->
              <el-input-number v-model="socketSetDataForm.n19" placeholder="1~3000" size="small" :max="3000" :min="1" :step="10"></el-input-number>
              <el-radio :label="'n19' + '-' +socketSetDataForm.n19"></el-radio>
            </el-form-item> 
            <el-form-item label="过热保护功能是否启用" class="set-device-form-item-right">
              <!-- <el-input v-model="socketSetDataForm.n20" placeholder="" size="small"></el-input> -->
              <el-select 
                v-model="socketSetDataForm.n20" clearable>
                <el-option
                  v-for="item in sfValue"
                  :key="item.value"
                  :label="item.label"
...
<script>
  ...
  export default {    
    ...
    watch: {
      ...
      // 监听状态群控弹框网关复选值改变 查询插座设备列表
      'gatewayCheckList': function (val) {
        // console.log(val)
        if(this.turnBtn == false) {
    ...
    methods: {      
      ...
      getGatewayList (val) {
        ...
        this.$http({
          url: this.$http.adornUrl('/admin/tequipoutlet/comm'),
          method: 'post',
          ...
          if (data && data.code === 0) {
            ...
            if(val == 1) {
              let arr = []
              arr[0]= data.data[0].commId
              this.gatewayCheckList = arr
            }
          } else {
            this.gatewayList = []
          }
      ...
      getDataControlList () {
        ...
        this.$http({
          ...
          data: this.$http.adornData({
            ...
            // 'runStatus': null
            'equipIdList': null,  // 设备集合
            'runStatus': null,  // 	运行状态
            'type': null, // 群控类型：1:广播，2：设备，选择1的时候，必须选择通讯设备才能点击设定，设备不能选择，选择2的时候，必须选择设备才能点击设定，通讯设备不能选择
            'commIdList': this.gatewayCheckList.length == 0 ? null : this.gatewayCheckList,  // 网关 通讯设备集合
            'useState': this.radio1.toString()  // 设定状态，用于查询设备列表集合
          }),
        }).then(({ data }) => {
          if (data && data.code === 0) {
      ...
      turns () {
        ...
        // 1:广播，2：设备
        if(this.checkboxed.length == 0 && (this.radio2 == 2 || this.radio2 == null)) {
          this.$message({
            message: '请勾选要设置的设备',
            type: 'warning',
            duration: 1500,
        ...
        } else if(this.gatewayCheckList.length == 0 && (this.radio2 == 1 || this.radio2 == null)){
          this.$message({
            message: '请勾选要设置的网关',
            type: 'warning',
            duration: 1500,
        ...
        }else if(this.gatewayCheckList.length == 0 && this.checkboxed.length == 0 && this.radio2 == null) {
          this.$message({
            message: '请设置选项',
            type: 'warning',
            duration: 1500,
          ...
          this.$confirm('是否继续?', '提示', {
            ...
            if(this.radio2 == 2) {
              ...
              for (let i = 0; i < this.dataControlList.length; i++) {
                equipIds.push(this.dataControlList[i].id)
                equipId.push(this.dataControlList[i].equipId)
              }
            }            
            ...
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'equipIdList': this.radio2 == 1 ? null : equipId,  // 设备集合
                'runStatus': this.radio1.toString(),  // 	运行状态
                'type': this.radio2.toString(), // 群控类型：1:广播，2：设备，选择1的时候，必须选择通讯设备才能点击设定，设备不能选择，选择2的时候，必须选择设备才能点击设定，通讯设备不能选择
                'commIdList': this.radio2 == 1 ? this.gatewayCheckList : null,  // 网关 通讯设备集合
                'useState': null  // 设定状态，用于查询设备列表集合
              }),
            }).then(({ data }) => {
              if (data && data.code === 0) {
                /* this.$message({
                ...
                if(this.radio2 == 2) {
                  ...
                  if(_this.controlAllWs) {
                    ...
                    _this.controlAllWs.onmessage = function (evt) {
                      ...
                      if((evt.data)!="pong"){
                        ...
                        // let datas = {"id":"32011500010000400000009-1500","value":"1"}
                        /* _this.dataControlList.map(e => {
                  ...
                  this.turnBtn = false
                  for( let i=0;i<this.dataControlList.length;i++) {
                    this.dataControlList[i].executeStatus = 0                   
                    this.dataControlList[i].runStatus = this.radio1
                  }
                }                
      ...
      // 单个页面定值查询按钮 打开弹框必须选择一个定值才可加载定值查询
      constantVlueQuery () {
          ...
          this.$http({
            ...
            data: this.$http.adornData({
              ...
              "comms" : [ {   //通信设备集
                ...
                "param" : {
                  "group" : "0",   //定值参数组号
                  "index" : this.checkList.split('-')[0].substr(1)   //定值对象序号
                },
                "datas" : [ {
            ...
            if(data && data.code === 0) {
              ...
              if ('WebSocket' in window) {
                  let arrId = []
                  // console.log(this.checkList)
                  arrId.push(this.dialogTitleId + '-' + this.checkList.split('-')[0].substr(1))
                  /* for (let i=0;i<32;i++) {
      ...
      list() {
        ...
        this.$http({
          ...
          data: this.$http.adornData({
            ...
            'floorId': this.floorValue,
            'type': this.typeValue,
            'equipName': this.input5 == '' ? null : this.input5
          })
        }).then(({
          data
        }) => {
...
.socket-floor  .sockets-list {
  ...
  .set-device-form-item-right >>> .el-select, .set-device-form-item-right >>> .el-cascader, .set-device-form-item-right >>> .el-input, .set-device-form-item-right >>> .el-input-number{
    flex: 3;
  }
...
.socket-floor .groupcontrol-button {
  margin-bottom: 10px
  /* height: 10%; */
  /* position: absolute;
  right: 0;
...
.socket-floor .groupcontrol-top-left {
  flex: 2;
  min-width: 200px;
  display: flex;
  flex-direction: column;
...
.socket-floor .groupcontrol-top-right {
  flex: 4;
  padding: 1% 2%;
  overflow-y: auto
}
.socket-floor .groupcontrol-top-right::-webkit-scrollbar {
  display: none
}
.socket-floor .groupcontrol-top-btn {
  display: flex;
