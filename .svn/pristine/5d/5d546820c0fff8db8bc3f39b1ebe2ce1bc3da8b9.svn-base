        ...
        if(this.floorWs != null) {
          ...
          _this.floorWs.onmessage = function(evt) {
            ...
            if (evt.data != "pong") {
              ...
              // console.log(receive)
              // let receive = [{total:'3',sn:'1002',status:'0',pid:'1',code:'2'},
              //   {total:'',sn:'1003',status:'1',pid:'2',code:'3'},
              //   {total:'',sn:'1004',status:'0',pid:'2',code:'4'}]
              receive.unshift({total:receive[0].total,sn:'',status:'',pid:'',code:'1'})             
              ...
              if (receive.length > 1) {
                for (let i = 0; i < receive.length; i++) {
                  if (i == 0) {
                    ...
                    let source = null;
                    if (receive[i].status == "1") {
                      source = require("@/assets/images/topoon.png");
                    } else if (receive[i].status == "0") {
                      source = require("@/assets/images/topooff.png");
                    }
                    receive[i] = {
                      key: receive[i].code,
