      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tooltip class="item" effect="dark" content="修改" placement="top"> 
            <el-button v-if="isAuth(OPTAUTH_UPDATE)" type="text" size="small" @click="addOrUpdateHandle(scope.row.deptId)"><i class="el-icon-edit-outline istyle"></i></el-button>
          </el-tooltip>
          <el-tooltip class="item" effect="dark" content="删除" placement="top"> 
            <el-button v-if="isAuth(OPTAUTH_DELETE)" type="text" size="small" @click="deleteHandle(scope.row.deptId)"><i class="el-icon-delete istyle"></i></el-button>
          </el-tooltip>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  import AddOrUpdate from './sysdeptinfo-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    mounted () {
      console.log("dept asdasdasddddddddddddddddd")
    ...
    methods: {
      ...
      getDataList (params) {
        ...
        this.$http({
          url: this.$http.adornUrl('/sys/deptinfo/list'),
          method: 'get',
          params: this.$http.adornParams({
            'page': this.pageIndex,
            'limit': this.pageSize,
      ...
      addOrUpdateHandle (id = null) {
        ...
        this.$nextTick(() => {
          this.$refs.addOrUpdate.init(id,this.dataForm.orgId)
        })
      },
      // 删除
      deleteHandle (id) {
        ...
        this.$confirm(`确定删除操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/sys/deptinfo/delete'),
            method: 'post',
