...
export default {
  data () {
    var validatePositiveNumber = (rule, value, callback) => {
      ...
      if (!isPositiveNumber(value)) {
        ...
        // this.setDictionaryDataForm.subCodeType = null
        callback()
      }
    }
  ...
  methods: {
    ...
    dictionaryDataFormSubmit (setDictionaryDataForm) {
      // console.log(this.setDictionaryDataForm)
          ...
          this.$confirm(`确定提交?`, '提示', {
            ...
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                codeType: this.setDictionaryDataForm.codetype.toString(),
                typeName: this.setDictionaryDataForm.typeName,
                code: this.setDictionaryDataForm.code,
                codeName: this.setDictionaryDataForm.codeName,
                subCodeType: this.setDictionaryDataForm.subCodeType,
                parentId: this.setDictionaryDataForm.parentId,
                sortNo: this.setDictionaryDataForm.sortNo,
                remark: this.setDictionaryDataForm.descirb
              })
            }).then(({data}) => {
              if(data && data.code === 0) {
          ...
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              this.$nextTick(()=> {               
                ...
                this.setDictionaryDataForm.subCodeType = data.tCodeDetail.subCodeType ? data.tCodeDetail.subCodeType.toString():null
